...
export const DEFAULT_SETTINGS = {
  ...
  otApprovalRequired: true, // only authority-approved OT hours are paid
  perDayBasis: "fixed30", // days/month for per-day rate & OT: "working" | "fixed26" | "fixed30"
  deductAbsent: true, // subtract a day's pay per absent day (only UNPAID absences)
  halfDayPayFactor: 0.5, // a half day is paid at 50%
  lateGroupSize: 4, // every N late days deducts one day's pay; first (N-1) are graced

  // Paid-leave entitlement, per leave year. Paid leave is not deducted from pay.
  earnedLeavePerYear: 10,
  sickLeavePerYear: 7,
  leaveYearStartMonth: 7, // leave year runs July → June
}
...
export const STORAGE_KEYS = {
  ...
  input: "gt_input_v1",
  approvedOt: "gt_approved_ot_v1", // legacy: { "YYYY-MM": { empId: approvedHours } }
  adjustments: "gt_adjustments_v1", // { "YYYY-MM": { ot:{}, penalty:{}, bonus:{} } }
  theme: "gt_theme",
